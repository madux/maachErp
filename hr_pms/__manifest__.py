...

{
    ...
    'description': """ 
        HR Performance Management: To enable users generate PMS for employees
    """,
    'depends': ['base','hr'],
    'data': [
...
# {
#     'name': 'HR Performance Management (PMS)',
#     'version': '13.0',
#     'author': "Maduka Chris Sopulu / QIS Solution",
#     'summary': 'HR Performance Management: To enable users generate PMS for employees',
#     'depends': ['base','hr'],#, 'workforce_planning'],
#     'description': "HR Performance Management(PMS)",
#     "data": [
#         'security/security_view.xml',
#         'security/ir_rule.xml',
#         'security/ir.model.access.csv',
