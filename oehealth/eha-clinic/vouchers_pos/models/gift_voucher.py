...
class GiftVoucherPos(models.Model):
    ...
    expiry_date = fields.Date(string="Expiry Date", required=False, help='The expiry date of Voucher.')
...
class GiftCouponPos(models.Model):
    ...
    voucher = fields.Many2one('gift.voucher.pos', string="Voucher", required=False)
