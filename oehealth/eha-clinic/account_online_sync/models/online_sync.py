...
class ProviderAccount(models.Model):
    ...
    company_id = fields.Many2one('res.company', required=False, readonly=True, default=lambda self: self.env.company)
...
class OnlineAccount(models.Model):
    ...
    name = fields.Char(string="Journal Name", required=False)
