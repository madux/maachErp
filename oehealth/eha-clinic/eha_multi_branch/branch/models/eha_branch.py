...
class EhaBranch(models.Model):
    ...
    parent_id = fields.Many2one('eha.branch', 'Parent Branch')
    ...
    #     branch = self.env['eha.branch'].create({
    #         'name':company.name,
    ...
    #     'account.analytic.line', 'oeh.medical.appointment', 'oeh.medical.prescription', 
    #     'oeh.medical.lab.test', 'oeh.medical.evaluation', 'oeha.medical.imaging.test', 
    #     'oeh.medical.vaccines', 'purchase.order', 'purchase.order.line', 'sale.order.line', "sale.order", 
