...
class StockWarehouse(models.Model):
    ...
    branch_id = fields.Many2one('eha.branch', string='Branch', default=lambda self: self.env.user.branch_id.id, required=False)
...
class Orderpoint(models.Model):
    ...
    branch_id = fields.Many2one('eha.branch', 'Branch', readonly=True, store=True, default=lambda self: self.env['res.partner']._branch_default_get())
