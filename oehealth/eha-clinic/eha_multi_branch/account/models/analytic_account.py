...
class AccountAnalyticAccount(models.Model):
    ...
    branch_id = fields.Many2one('eha.branch', string='Branch', required=False, default=lambda self: self.env.user.partner_id.branch_id)


class AccountAnalyticLine(models.Model):
    _inherit = 'account.analytic.line'
    branch_id = fields.Many2one('eha.branch', string='Branch',required=False, readonly=True, default=lambda self: self.env.user.partner_id.branch_id)
