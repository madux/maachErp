...
class CrossoveredBudget(models.Model):
	...
	name = fields.Char('Budget Name', required=False, states={'done': [('readonly', True)]})
	...
	state = fields.Selection([
		...
		('validate', 'Validated'),
		('done', 'Done')
		], 'Status', default='draft', index=True, required=False, readonly=True, copy=False)
...
class CrossoveredBudgetLines(models.Model):
	...
	crossovered_budget_id = fields.Many2one('crossovered.budget', 'Budget', ondelete='cascade', index=True, required=False)
