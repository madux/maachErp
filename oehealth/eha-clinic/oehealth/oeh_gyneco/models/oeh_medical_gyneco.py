...
class OeHealthPerinatalMonitor(models.Model):
    ...
    name = fields.Char(string='Internal Code', size=128, required=False, readonly=True, default=lambda *a: '/')
    date = fields.Datetime(string='Date and Time', required=False, default=datetime.datetime.now())
