...
class OeHealthCenters(models.Model):
    ...
    partner_id = fields.Many2one('res.partner', string='Related Partner', required=False,ondelete='cascade', help='Partner-related data of the hospitals')
...
class OeHealthCentersBuilding(models.Model):
    ...
    name = fields.Char(string='Name', size=128, required=False, help="Name of the building within the institution")
    institution = fields.Many2one('oeh.medical.health.center', string='Health Center',required=False)
...
class OeHealthCentersWards(models.Model):
    ...
    name = fields.Char(string='Name', size=128, required=False, help="Ward / Room code")
    institution = fields.Many2one('oeh.medical.health.center',string='Health Center', required=False)
    building = fields.Many2one('oeh.medical.health.center.building',string='Building', required=False)
...
class OeHealthCentersBeds(models.Model):
    ...
    product_id = fields.Many2one('product.product', string='Related Product', required=False, ondelete='cascade', help='Product-related data of the hospital beds')
    ...
    bed_type = fields.Selection(BED_TYPES,string='Bed Type', required=False, default=lambda *a: 'Gatch Bed')
