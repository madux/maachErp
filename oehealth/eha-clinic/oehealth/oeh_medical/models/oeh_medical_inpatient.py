...
class OeHealthInpatient(models.Model):
    ...
    name = fields.Char(string='Inpatient #', size=128, readonly=True, required=False, default=lambda *a: '/')
    ...
    admission_type = fields.Selection(ADMISSION_TYPE, string='Admission Type', required=False, readonly=True, states={'Draft': [('readonly', False)]})
    admission_reason = fields.Many2one('oeh.medical.pathology', string='Reason for Admission', help="Reason for Admission", required=False, readonly=True, states={'Draft': [('readonly', False)]})
    ...
    ward = fields.Many2one('oeh.medical.health.center.ward', string='Ward', required=False, readonly=True, states={'Draft': [('readonly', False)]})
    bed = fields.Many2one('oeh.medical.health.center.beds', string='Bed', required=False, readonly=True, states={'Draft': [('readonly', False)]})
...
class OeHealthInpatientProfile(models.Model):
    ...
    ward = fields.Many2one('oeh.medical.health.center.ward', string='Ward', required=False, readonly=True)
    bed = fields.Many2one('oeh.medical.health.center.beds', string='Bed', required=False, readonly=True)
