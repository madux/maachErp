...
class OeHealthDoseUnit(models.Model):
    ...
    name = fields.Char(string='Unit', size=32, required=False)
...
class OeHealthDrugRoute(models.Model):
    ...
    name = fields.Char(string='Route', size=32, required=False)
...
class OeHealthDrugForm(models.Model):
    ...
    name = fields.Char(string='Form', size=32, required=False)
    code = fields.Char(string='Code', size=64)
