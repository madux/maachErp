odoo.define('sign.PDFIframeExtension', function (require) {
    'use strict';
...
odoo.define('sign.DocumentExtension', function (require) {
    'use strict';
...
odoo.define('sign.utilsExtension', function (require) {
    'use strict';
...
// Signing part
odoo.define('sign.document_signingExtension', function(require) {
    'use strict';
    ...
    var PublicSignerDialog = Dialog.extend({
        ...
        open: function(name, mail) { 
            ...
            this.mails = "mailing"; 
                ...
                mail = self.getQueryParam('email')
                this.opened(function() {
                    self.$inputs = self.$('input');
                    self.$("#o_sign_public_signer_name_input").val(name);
                    self.$("#o_sign_public_signer_mail_input").val(mail);
                    
                    //disable fields
                    self.$("#o_sign_public_signer_name_input").prop('disabled', true);
                    self.$("#o_sign_public_signer_mail_input").prop('disabled', true);
