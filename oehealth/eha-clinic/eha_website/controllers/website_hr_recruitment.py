...
class WebsiteHrRecruitment(http.Controller):
    ...
    def jobs(self, country=None, department=None, office_id=None, **kwargs):
        ...
        domain = request.website.website_domain() + [('state', '!=', 'open')]
    ...
    @http.route('''/jobs/detail/<model("hr.job", "[('website_id', 'in', (False, current_website_id)),('state', '!=', 'open')]"):job>''', type='http', auth="public", website=True)
    ...
    @http.route('''/jobs/apply/<model("hr.job", "[('website_id', 'in', (False, current_website_id)),('state', '!=', 'open')]"):job>''', type='http', auth="public", website=True)
