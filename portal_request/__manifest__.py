{
    ...
    'assets': {
        ...
        'portal_request/static/src/css/request_form.css',
        'portal_request/static/src/css/request_form.css',
        'portal_request/static/src/js/core/jquery-ui.min.js',
        'portal_request/static/src/css/core/jquery-ui.css',
        # '/portal_request/static/src/js/core/select2.min.js',
        '/portal_request/static/src/css/core/select2.min.css',
        '/portal_request/static/src/js/core/select2.min.js',
        '/portal_request/static/src/js/plugins/blockUI.min.js',
