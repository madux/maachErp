...
1. Copy the `website_odoo_experience_africa` folder into your Odoo
...
```
website_odoo_experience_africa/
├── __init__.py
├── __manifest__.py
├── controllers/
│   ├── __init__.py
...
3. Replace the `src` with:
   ...
   - a path to a static asset you add under
     `static/src/img/...` (e.g. `src="/website_odoo_experience_africa/static/src/img/mascot.png"`),
     **or**
...
- Edit the XML directly and upgrade the module (`-u website_odoo_experience_africa`), or
